...
String module = "ProductDisable.groovy";
...
final String PROD_STAT_ENABLED = "ENABLED"; // 架上
final String PROD_STAT_DISABLED = "DISABLED"; // 架下
final String PROD_STAT_ENABLE = "ENABLE"; // 架上
final String PROD_STAT_DISABLE = "DISABLE"; // 架下
...
try {
	...
	for (prodId in prodIds) {
		...
		if (null == tmpProductEnable) {
			...
			tmpProductEnable.set("tmpEnable", PROD_STAT_DISABLE);
