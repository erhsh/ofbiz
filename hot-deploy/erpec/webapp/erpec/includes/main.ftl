...
BUI.use('common/main',function(){
  var config = [
        ...
        id:'goods',
        homePage:'goods-manage',
        menu:[{
            text:'商品管理',
            items:[
              {id:'goods-manage',text:'商品管理',href:'/erpec/goods/control/goodsMgmtView',closeable:false},
              {id:'goods-manage',text:'商品审核',href:'/erpec/goods/control/goodsCheckView',closeable:false}
            ]
          }]
      },{
        id : 'users',
